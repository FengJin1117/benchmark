...
# NEW_PATH="/data7/fwh/data/suno/pop"
GENRE="rock"
NEW_PATH="/data7/fwh/benchdata/suno_score/${GENRE}"
sed -i "s|^OPENCPOP=.*|OPENCPOP=\"$NEW_PATH\"|" "$DIR/db.sh"
echo "数据集路径：${NEW_PATH}"
DATA_SOURCE="suno_${GENRE}"
...
#     --write_collected_feats true \
#     --inference_nj 1 \
#     --vocoder_file /data2/fwh/vocoder/train_nodev_opencpop_hifigan.v1/checkpoint-250000steps.pkl \
